...
<head>
    ...
    <title>Ants-Station Dashboard</title>
        ...
        $.getJSON("./ajax.php?action=server_info", function(data) {
            if (data != null && data['top'] != null) {
                ...
                $(".chart").each(function(index) {
                    $(this).data('easyPieChart').update($(this).closest("span").text().replace(
                        /[^0-9\.]/g, ''));
    ...
    <div class="container">
        ...
        <div id="system-status" class="panel panel-default" style="margin-bottom: 5px">
            <div class="panel-heading">
                <h3 class="panel-title">System Information
                    <!--a href="?updated" target="_top" class="btn btn-success pull-right" style="margin:-6px -11px; color: white;"><i class="fa fa-refresh"></i></a-->
                </h3>
            </div>
                ...
                <div class="row" style="margin: 0;">
                    ...
                    <div class="col-xs-6 col-sm-3 text-center">
                        <span class="chart" data-percent="<?php echo $disk_percentage; ?>">
                            <span class="percent"><span
                                    id="disk_percentage"><?php echo $disk_percentage; ?></span><i>%</i></span>
                    ...
                    <div class="col-xs-6 col-sm-3 text-center">
                        <span class="chart" data-percent="<?php echo $memory_percentage; ?>">
                            <span class="percent"><span
                                    id="memory_percentage"><?php echo $memory_percentage; ?></span><i>%</i></span>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            <tr>
                                <td style="width:30%;vertical-align:middle; padding:8px;"><strong>System
                                        hostname</strong></td>
                                <td style="width:70%; vertical-align:middle; padding:8px;"><span
                                        data-id="sysinfo_host"><?php echo gethostname(); ?>
                                        (<?php echo $_SERVER['SERVER_ADDR'];?>)</span></td>
                            </tr>
                            <tr>
                                <td style="width:30%;vertical-align:middle; padding:8px;"><strong>Operating
                                        system</strong></td>
                                <td style="width:70%; vertical-align:middle; padding:8px;"><span
                                        data-id="sysinfo_os"><?php echo $operating_system; ?></span></td>
                            </tr>
                            <tr>
                                <td style="width:30%;vertical-align:middle; padding:8px;"><strong>Processor
                                        information</strong></td>
                                <td style="width:70%; vertical-align:middle; padding:8px;"><span
                                        data-id="sysinfo_kernel_arch"><?php echo $cpu_info; ?></span></td>
                            </tr>

                            <tr>
                                <td style="width:30%;vertical-align:middle; padding:8px;"><strong>System uptime</strong>
                                </td>
                                <td style="width:70%; vertical-align:middle; padding:8px;"><span
                                        data-id="sysinfo_uptime"><span id="uptime"><?php echo $uptime; ?></span></span>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:30%;vertical-align:middle; padding:8px;"><strong>Current system
                                        time</strong></td>
                                <td style="width:70%; vertical-align:middle; padding:8px;"><span
                                        data-id="sysinfo_disk_space"><span id="date"><?php echo $date; ?></span></span>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:30%;vertical-align:middle; padding:8px;"><strong>Running
                                        processes</strong></td>
                                <td style="width:70%; vertical-align:middle; padding:8px;"><span
                                        data-id="sysinfo_running_proc"><a href="./processes.php"
                                            id="processes"><?php echo $processes; ?></a></span></td>
                            </tr>
                            <tr>
                                <td style="width:30%;vertical-align:middle; padding:8px;"><strong>CPU load
                                        averages</strong></td>
                                <td style="width:70%; vertical-align:middle; padding:8px;"><span
                                        data-id="sysinfo_load"><span id="load0"><?php echo $load[0]; ?></span> (1 min)
                                        <span id="load1"><?php echo $load[1]; ?></span> (5 mins) <span
                                            id="load2"><?php echo $load[2]; ?></span></span> (15 mins)</span></td>
                            </tr>
                            <tr>
                                <td style="width:30%;vertical-align:middle; padding:8px;"><strong>Real memory</strong>
                                </td>
                                <td style="width:70%; vertical-align:middle; padding:8px;"><span
                                        data-id="sysinfo_real_memory"><span
                                            id="memory_total"><?php echo $memory_total; ?></span> KiB total / <span
                                            id="memory_used"><?php /*echo ($memory_used - $memory_buffers - $memory_cached);*/ echo ($memory_used); ?></span>
                                        KiB used</span></td>
                            </tr>

                            <tr>
                                <td style="width:30%;vertical-align:middle; padding:8px;"><strong>Local disk
                                        space</strong></td>
                                <td style="width:70%; vertical-align:middle; padding:8px;"><span
                                        data-id="sysinfo_disk_space"><span
                                            id="disk_total"><?php echo $disk_total; ?></span> GB total / <span
                                            id="disk_free"><?php echo $disk_free; ?></span> GB free / <span
                                            id="disk_used"><?php echo $disk_used; ?></span> GB used</span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
