...
<head>
    ...
    <title>Ants-Station Actions</title>
            ...
            <div class="panel-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <button type="submit" class="btn btn-primary"
                                onclick="return confirm('Are you sure?')">Kill</button>
                        </div>
                    </div>
                ...
                <form method="post" style="margin-top: 20px;">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <button type="submit" class="btn btn-primary"
                                onclick="return confirm('Are you sure?')">Stop</button>
                        </div>
                    </div>
                ...
                <form method="post" style="margin-top: 20px;">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <button type="submit" class="btn btn-primary"
                                onclick="return confirm('Are you sure to reboot RPi?')">Reboot</button>
                        </div>
                    </div>
                ...
                <form method="post" id="advanced_command" style="margin-top: 20px;">
                    <div class="form-group row">
                        <label class="col-sm-2 form-control-label" for="cmd">Execute command <b>(Advanced users
                                only!)</b></label>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="checkbox">
                                <label><input type="checkbox" id="background_command" value="">Execute in
                                    background</label>
                            </div>
                        </div>
                        <div class="col-sm-4">
                ...
                <div class="well well-sm" id="command_logs">
                    ...
                    <code>cd <?php echo dirname(__FILE__); ?> && sudo git pull origin</code> to update Ants-Station
                    Dashboard (after this you have to edit the config.php file manually).<br />
                    <code>sudo chmod 0777 <?php echo dirname(__FILE__); ?>/include/config.php</code> to make the config
                    file writable in case you can't write any data to it.
