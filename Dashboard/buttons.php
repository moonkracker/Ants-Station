...
<head>
    ...
    <title>Ants-Station Buttons</title>
    ...
    function add_button() {
        ...
        html +=
            '<button type="button" class="btn btn-default" onclick="javascript:jQuery(\'#dialog\').modal(\'hide\');">Cancel</button> ';
        html +=
            ' <button type="button" class="btn btn-default" id="send-message-btn" onclick="javascript:submit_button();jQuery(this).prop(\'disabled\', true);">Send</button>';
        html += '</div>';
    ...
    function edit_button(button_id) {
        ...
        jQuery.ajax({
            ...
            success: function(data) {
                ...
                $('#dialog .create-button-form #button_style option[value="' + data.button_style + '"]')
                    .prop('selected', true);
                $('#dialog .create-button-form #button_size option[value="' + data.button_size + '"]').prop(
                    'selected', true);
            }
        });
    ...
    <div id="create-button-dialog" style="display: none">
        <form style="width: 100%;" class="create-button-form">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="button_title" placeholder="Enter a some title text"
                    name="button_title">
            </div>
            <div class="form-group">
                <label for="button_command">Button command:</label>
                <input type="text" class="form-control" id="button_command"
                    placeholder="Enter a command to be executed on a button click" name="button_command">
            </div>
            <div class="form-group">
                <label for="button_icon">Button icon:</label>
                <input type="text" class="form-control" id="button_icon"
                    placeholder="Insert icon class name from fontawesome, i.e. fa-plus" name="button_icon">
            </div>
            <div class="form-group">
