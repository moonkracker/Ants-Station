    ...
    <div class="container">
        ...
        <div id="system-status" class="panel panel-default" style="margin-bottom: 5px">
            ...
            <div class="panel-body">
                ...
                <iframe src="<?php echo $gumcp_modules[$_REQUEST['module']]['module_index_file_relative_path']; ?>"
                    style="display: block; overflow:hidden;min-height:500px;height:100%;width:100%" height="100%"
